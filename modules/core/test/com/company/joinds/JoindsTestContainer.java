...
public class JoindsTestContainer extends TestContainer {

    public JoindsTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/joinds/app.properties",
    ...
    public static class Common extends JoindsTestContainer {

        public static final JoindsTestContainer.Common INSTANCE = new JoindsTestContainer.Common();
